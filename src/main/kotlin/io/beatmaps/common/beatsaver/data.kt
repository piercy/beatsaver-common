...
data class BeatsaverMap(val metadata: BeatsaverMetadata, val stats: BeatsaverStats, val description: String, val deletedAt: Instant?, val _id: String, val key: String, val name: String,
                        val uploader: BeatsaverUploader, val hash: String, val uploaded: Instant, val directDownload: String, val downloadURL: String, val coverURL: String)
...
data class BeatsaverMetadata(val difficulties: BeatsaverDifficulties, val duration: Int, val automapper: String?, val characteristics: List<BeatsaverCharacteristics>,
                             val levelAuthorName: String, val songAuthorName: String, val songName: String, val songSubName: String, val bpm: Float)
...
data class BeatsaverCharacteristicDifficulties(val easy: BeatsaverCharacteristicDifficulty?, val normal: BeatsaverCharacteristicDifficulty?,
                                               val hard: BeatsaverCharacteristicDifficulty?, val expert: BeatsaverCharacteristicDifficulty?,
